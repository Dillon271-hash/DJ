...
export const SEED_VENUES: SeedVenue[] = [
  ...
  { name: "Bootsy Bellows", city: "West Hollywood, CA" },
  { name: "Delilah", city: "West Hollywood, CA" },
  { name: "1 OAK", city: "West Hollywood, CA" },
  { name: "Harlowe", city: "West Hollywood, CA" },
  { name: "Create Nightclub", city: "Hollywood, CA" },
  { name: "Peppermint Club", city: "Los Angeles, CA" },
  { name: "Catch One", city: "Los Angeles, CA" },
  { name: "Los Globos", city: "Los Angeles, CA" },
  { name: "The Roxy", city: "West Hollywood, CA" },
  { name: "El Rey Theatre", city: "Los Angeles, CA" },
  { name: "The Wiltern", city: "Los Angeles, CA" },
  { name: "No Vacancy", city: "Los Angeles, CA" },
  { name: "The Belasco", city: "Los Angeles, CA" },
  { name: "Hollywood Palladium", city: "Hollywood, CA" },
  ...
  { name: "Marquee Dayclub", city: "Las Vegas, NV" },
  { name: "Hakkasan", city: "Las Vegas, NV" },
  { name: "Zouk Las Vegas", city: "Las Vegas, NV" },
  { name: "Tao Nightclub", city: "Las Vegas, NV" },
  { name: "Drai's Nightclub", city: "Las Vegas, NV" },
  { name: "LIGHT Nightclub", city: "Las Vegas, NV" },
  { name: "JEWEL Nightclub", city: "Las Vegas, NV" },
  { name: "Encore Beach Club", city: "Las Vegas, NV" },
  { name: "Wet Republic", city: "Las Vegas, NV" },
  { name: "Ayu Dayclub", city: "Las Vegas, NV" },
  { name: "Liquid Pool Lounge", city: "Las Vegas, NV" },
  { name: "Intrigue Nightclub", city: "Las Vegas, NV" },
  { name: "Apex Social Club", city: "Las Vegas, NV" },
  { name: "Kaos Nightclub", city: "Las Vegas, NV" },
  { name: "Ghost Bar", city: "Las Vegas, NV" },
  { name: "Body English", city: "Las Vegas, NV" },
  { name: "Rain Nightclub", city: "Las Vegas, NV" },
